...
<!--    当没有找到学校时-->
    <div class="cannotFindCampus" style="font-size:25px; margin-top: 20px; margin-bottom: 20px;" v-if="!isCollegeFind">
      <div style="font-weight: lighter; font-size: 30px">没有找到 <span style="font-weight: bold">{{currentCollege}}</span></div>
      找不到你想要的学校?
      <el-link type="primary" @click="$router.push('/comment')"
               style="font-size :23px;font-weight: bold;color:rgb(5, 138, 182); margin-bottom:3px;"> 点击这里</el-link>
    </div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        briefCampus: [{ id: "九龙湖校区", rate: 3.9, comNum: 302, routerUrl: '/campus/九龙湖校区', url: "https://gitee.com/thisisbadBao/imgrepo/raw/master/imgrepo1/20210716160403.svg" },
                      { id: "四牌楼校区", rate: 4.5,  comNum: 491, routerUrl: '/campus/四牌楼校区',  url: "https://gitee.com/thisisbadBao/imgrepo/raw/master/imgrepo1/20210716160403.svg"}],
        campusId: "",
